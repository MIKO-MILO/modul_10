          ...
          Obx(
            () => InkWell(
              ...
              child: Container(
                ...
                child: controller.newImage.value == null
                    ? (controller.argsData['image'] != null
                          ? ClipRRect(
                              borderRadius: BorderRadius.circular(16),
                              child: Image.network(
                                controller.argsData['image'],
                                fit: BoxFit.cover,
                              ),
                            )
                          : Column(
                    ...
                    : ClipRRect(
                        ...
                        child: kIsWeb
                            ? Image.network(
                                controller.newImage.value!.path,
                                fit: BoxFit.cover,
                              )
                            : Image.file(
                                File(controller.newImage.value!.path),
                                fit: BoxFit.cover,
                              ),
                      ),
              ),
